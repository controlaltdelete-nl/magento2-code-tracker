...
class BillingAddressManagementTest extends TestCase
{
     ...
     */
    private CartAddressMutexInterface $cartAddressMutex;
    ...
    public function testSetAddress()
    {
        ...
        $this->cartAddressMutex->expects($this->once())->method('execute')
            ->with(
                ...
                [$this->model, 'assignBillingAddress'],
                $addressId,
    ...
    public function testSetBillingAddress()
    {
        ...
        $this->assertEquals($addressId, $this->model->assignBillingAddress($address, $quoteMock, true));
    }
}
